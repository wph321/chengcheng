   ...
   <div id="templatemo_menu5">
      ...
      <ul>
       <li><a href="/chengcheng/ShowInIndexServlet">首页</a></li>
        ...
        <li></li>
        <li><a href="/chengcheng/jsp/activitycircle.jsp">活动</a></li>
          ...
          <div class="sidebar_box">
            <h2>城程应用</h2>
              ...
              <ul class="categories_list">
                <li><a href="/chengcheng/ShowInActivityCircleServlet?type=0">发活动</a></li>
        ...
        <div id="content_middle">
          <h3>聊天室</h3>
           <table width="100%" border="1">
            <tr>
              <td height="196" valign="top"><h2>活动聊天室（sky）</h2>
                <table width="16%" border="1">
                  <tr>
                    <td align="center">张丽</td>
                  </tr>
                  <tr>
                    <td align="center">李娟</td>
                  </tr>
                  <tr>
                    <td align="center">王耀华</td>
                  </tr>
                  <tr>
                    <td align="center">赵宇</td>
                  </tr>
                  <tr>
                    <td align="center" valign="middle">林琳</td>
                  </tr>
                </table>
              <p>&nbsp;</p></td>
            </tr>
            <tr>
              <td><h2>好友聊天室（friends）</h2>
                <table width="16%" border="1">
                  <tr>
                    <td align="center">王丽</td>
                  </tr>
                  <tr>
                    <td align="center">赵娟</td>
                  </tr>
                  <tr>
                    <td align="center">王华</td>
                  </tr>
                  <tr>
                    <td align="center">林宇</td>
                  </tr>
                  <tr>
                    <td align="center" valign="middle">张琳</td>
                  </tr>
                </table>
                <p></p>
              <p>&nbsp;</p></td>
...
<table width="170" height="50" border="1" style="border:none">
 ...
 <c:if test="${!empty sessionScope.lstmyAct}">  
  ...
  <div class="cleaner"></div>
<!-- end of templatemo_body_wrapper5 -->
