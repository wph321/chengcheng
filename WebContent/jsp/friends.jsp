...
function deleteFriend(id){
	if(confirm("确定删除好友吗?")){
	location="/chengcheng/DeleteFriendsServlet?uccid="+id;
	}
}
</script>
        ...
        <div id="content_middle">
          ...
          <table width="100%" border="0">
            <tr align="center" valign="middle">
              ...
              <td width="33%" height="30"> <form action="/chengcheng/SearchFriendServlet" method="get">
           ...
           <c:forEach items="${ requestScope.lstFri}" var="friend">
            ...
            %>
               ...
               <p>
                <img src="/chengcheng/upload/images/photo/${friend.fphoto}" alt="" width="240" height="240" align="middle"/>
               </p>
               <p>&nbsp;</p>
               <p>
               ...
               <table width="200" height="10" border="0" style="border:none">
                 ...
                 <form name="form2" method="post" action="/chengcheng/SendMessagesServlet">
