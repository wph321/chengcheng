   ...
   <div id="templatemo_content_wrapper">
      ...
      <div id="content_top"></div>
       <div id="content_middle"> 
           <h2>修改密码</h2>
           <form action="/chengcheng/ModifyServlet?type=2" method="post" enctype="multipart/form-data" name="form1" id="form1" >
             <table width="1000" border="0" align="center">
             <tr  align="right"><td>
             <a href="/chengcheng/PreModifyServlet">返回修改资料</a>
              </tr>
             <tr><td>
             <input type="hidden" name="uccid" id="uccid" value="${requestScope.uccid }"/>
             </td></tr>
              <tr>
                <td width="297" height="38"><div align="right">
                  <div align="right">原密码</div>
                </div></td>
                <td width="693" height="38"><input type="password" name="upwdformer" id="upwdformer" /></td>
              </tr>
              <tr>
                <td width="297" height="38"><div align="right">修改密码</div></td>
                <td width="693" height="38"><input type="password" name="upwdlater" id="upwdlater" /></td>
              </tr>
              <tr>
                <td height="38"><div align="right">确认密码</div></td>
                <td height="38"><input type="password" name="reupwdlater" id="reupwdlater" /></td>
              </tr>
              <tr>
                <td height="28" colspan="2"> &nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                   <p>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                     <input type="submit" name="submit" id="submit" value="确认修改" class="btn10" onMouseOver="this.style.backgroundPosition='left -40px'" onMouseOut="this.style.backgroundPosition='left top'" />
                  </p></td>
              </tr>
            </table>
          </form> 
